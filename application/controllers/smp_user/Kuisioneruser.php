...
class Kuisioneruser extends CI_Controller {
    ...
    function __construct() {
		parent::__construct();
        $this->load->model(FOLDER_SMP_USER.'m_kuisioneruser');
    }
	...
	function index() {
        if ( $this->session->userdata('status') != "login" and empty($this->session->userdata('username')) and empty($this->session->userdata('id_user')))
        {
            ...
            $this->load->view(FOLDER_SMP_USER.'datakuisioner' );
        }
	}
	...
	function form_addkuisioner(){
        ...
        if ( $this->session->userdata('status') == "login" and !empty($this->session->userdata('username')) and !empty($this->session->userdata('id_user')))
        {
            $this->load->view(FOLDER_SMP_USER.'form_addkuisioner');
        } else {
	...
	function form_editkuisioner(){
        ...
        if ( $this->session->userdata('status') == "login" and !empty($this->session->userdata('username')) and !empty($this->session->userdata('id_user')))
        {
            ...
            $this->load->view(FOLDER_SMP_USER.'form_editkuisioner', $data);
        } else {
            $this->load->view('v_sesiberakhir');
        }
        } else {
	...
	function form_uploadfilekuisioner(){
        ...
        if ( $this->session->userdata('status') == "login" and !empty($this->session->userdata('username')) and !empty($this->session->userdata('id_user')))
        {
            ...
            $this->load->view(FOLDER_SMP_USER.'form_uploadfilekuisioner', $data);
        } else {
            $this->load->view('v_sesiberakhir');
        }
        } else {
	...
	function form_lihatpdfkuisioner() {
		...
		if ( $this->session->userdata('status') == "login" and !empty($this->session->userdata('username')) and !empty($this->session->userdata('id_user')))
        {
		  ...
		  $this->load->view(FOLDER_SMP_USER.'form_lihatpdfkuisioner', $data);
		} else {
            $this->load->view('v_sesiberakhir');
        }
	  	} else {
	...
	function form_hapuskuisioner() {
		...
		if ( $this->session->userdata('status') == "login" and !empty($this->session->userdata('username')) and !empty($this->session->userdata('id_user')))
        {
		  $id_kuisioner = $this->input->get('id_kuisioner');
		  $data['n2'] = $this->m_kuisioneruser->getdatakuisioner($id_kuisioner);
		  $this->load->view(FOLDER_SMP_USER.'form_hapuskuisioner', $data);
		} else {
            $this->load->view('v_sesiberakhir');
        }
	  	} else {
	...
	function aksihapuskuisioner() {
	  ...
	  function aksiuploadfilekuisioner() {
        ...
        {
			$id_kuisioner=$this->input->post('editid_kuisioner');
			$nuptk_guru_smp=$this->input->post('editid_guru');
	...
	function form_gantinilai() {
		...
		if ( $this->session->userdata('status') == "login" and !empty($this->session->userdata('username')) and !empty($this->session->userdata('id_user')))
        {
		  ...
		  $this->load->view(FOLDER_SMP_USER.'form_gantinilaikuisioner', $data);
		} else {
            $this->load->view('v_sesiberakhir');
        }
	  	} else {
	...
	function aksigantinilaikuisioner() {
		...
		if ( $this->session->userdata('status') == "login" and !empty($this->session->userdata('username')) and !empty($this->session->userdata('id_user')))
        {
			...
			$data = $this->m_kuisioneruser->editpenilaiankuisioner2($data_kuisioner, $no_kuisioner, $id_kuisioner, $nuptk_guru_smp);
			if ($this->db->affected_rows() != 1) {
	...
	function form_hapushasilkuisioner() {
		...
		if ( $this->session->userdata('status') == "login" and !empty($this->session->userdata('username')) and !empty($this->session->userdata('id_user')))
        {
		  ...
		  $this->load->view(FOLDER_SMP_USER.'form_hapushasilkuisioner', $data);
		} else {
            $this->load->view('v_sesiberakhir');
        }
	  	} else {
	...
	function form_gantiuploadfilekuisioner() {
		...
		if ( $this->session->userdata('status') == "login" and !empty($this->session->userdata('username')) and !empty($this->session->userdata('id_user')))
        {
		  $no_kuisioner = $this->input->get('no_kuisioner');
		  $data['n2'] = $this->m_kuisioneruser->getdatahasilkuisioner2($no_kuisioner);
		  $this->load->view(FOLDER_SMP_USER.'form_gantiuploadfilekuisioner', $data);
		} else {
            $this->load->view('v_sesiberakhir');
        }
	  	} else {
	  ...
	  function aksigantiuploadkuisioner() {
		...
		if ( $this->session->userdata('status') == "login" and !empty($this->session->userdata('username')) and !empty($this->session->userdata('id_user')))
        {
            ...
            $data = $this->m_kuisioneruser->editpenilaiankuisioner($data_kuisioner, $no_kuisioner, $id_kuisioner, $nuptk_guru_smp);
			} 
			} else {
