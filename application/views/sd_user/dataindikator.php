		...
		<div class="row">
				<div class="col-sm-12">
					...
					<div class="kt-portlet kt-portlet--tab">
						...
						<i class="flaticon2-checking" style="padding-right:5px"></i> Indikator Kompetensi
						...
						<div class="kt-portlet__body">
							...
							<a class="btn btn-success btn-elevate btn-icon-sm btn-elevate2 btn-elevate-air2"
										href="<?php echo base_url().FOLDER_SD."indikator/form_addindikator";?>"
							...
							<a class="btn btn-brand btn-elevate btn-icon-sm btn-elevate2 btn-elevate-air2"
										href="<?php echo base_url().FOLDER_SD."indikator";?>"
										 id="guru_semua">
										<i class="flaticon2-checking"></i>
										Tampilkan Semua Indikator Kompetensi
									</a>

							<a class="btn btn-dark btn-elevate btn-icon-sm btn-elevate2 btn-elevate-air2"
										href="<?php echo base_url().FOLDER_SD."kompetensi";?>"
										 id="sekolah_semua">
							...
							<div class="alert alert-warning data_indikator" style="display:none"></div>
							<table class="table table-striped table-bordered table-hover data_indikator dataTables" id="data_indikator" width=100%>
								<thead>
									<tr>
										<th></th>
										<th>Tindakan</th>	
