...
var prov = opt.val();
if (!prov) return;
xmlhttp.open('get', '<?php echo base_url().FOLDER_SD; ?>sekolah/ambildatakotakab?nama_provinsi='+prov, true);
...
xmlhttp2.open('get', '<?php echo base_url().FOLDER_SD; ?>sekolah/ambildatakecamatan?nama_kotakab='+kotakab+'&nama_provinsi='+prov, true);
...
xmlhttp3.open('get', '<?php echo base_url().FOLDER_SD; ?>sekolah/ambildatakelurahan?nama_kec='+kec+'&nama_kotakab='+kotakab+'&nama_provinsi='+prov, true);
...
xmlhttp4.open('get', '<?php echo base_url().FOLDER_SD; ?>sekolah/ambildatanodaerah?nama_desa_kel='+kel+'&nama_kec='+kec+'&nama_kotakab='+kotakab+'&nama_provinsi='+prov, true);
	...
	$(document).on('click', "button#submit_data", function(){ 
		if ($('form.form_tambah_data').valid()) {
			...
			cache: false,
      		contentType: false,
    		  processData: false,
			url: "<?php echo base_url().FOLDER_SD;?>sekolah/aksiaddsekolah",
			data: databaru,
				beforeSend: function(){
				},
