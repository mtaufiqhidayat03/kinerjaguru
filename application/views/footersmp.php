...
$('#tambah_data').on('shown.bs.modal', function(e) {
	...
	<?php  } ?>			
		$(this).find('.modal-content').load(e.relatedTarget.href, function(response, status, xhr) {
		if (xhr.status == 200) {
			selectPlaceholder('#id_kompetensi_indikator_smp');
	...
	<?php  } ?>			
		...
		if (xhr.status == 200) {
			...
			dataType: 'json',
				...
				var initial2 = $('#editid_kompetensi_indikator_smp2').val();
				var $select2 = $('#editid_kompetensi_indikator_smp, #editid_kompetensi_indikator_smp_validate').select2();
			...
			var idkelompok2 = $('#editid_kompetensi_indikator_smp2').val();
			...
			selectPlaceholder('#editid_kompetensi_indikator_smp');
...
$('#upload_file').on('shown.bs.modal', function(e) {
		...
		if (xhr.status == 200) {
			...
			$('#edit_guru, #edit_guru_validate').select2({
				...
				ajax: {
					dataType: 'json',
					url: 'sekolah/ambildatagurusmpmengajar',
					delay: 500,
					data: function (params) {
