...
<tr>
<td width="2%"></td>
    <td width="92%"><h4>Apakah anda ingin menghapus <b><?php echo $row->nama_kuisioner; ?></b> untuk <?php echo $row->nama_guru; ?>  ?</h4></td>
    <td></td>
    </tr>
    <tr>
    <td colspan="3" style="display:none">
    <input name="no_kuisioner" type="text"  readonly value="<?php echo $row->no_kuisioner; ?>" />
    </td>
</tr>
<?php } ?>
</table>		
...
<script>
 $(function() {
	$(document).on('click',"button#hapus_data",function(){
			...
			url: "<?php echo base_url().FOLDER_SMP_USER;?>kuisioneruser/aksihapushasilkuisioner",
				beforeSend: function(){
				},
