...
<tr>
<td width="2%"></td>
    <td width="92%"><h4>Apakah anda ingin menghapus <b><?php echo $row->nama_kuisioner; ?></b> ?</h4></td>
    <td></td>
    </tr>
    <tr>
    <td colspan="3" style="display:none">
    <input name="id_kuisioner" type="text"  readonly value="<?php echo $row->id_kuisioner; ?>" />
    </td>
</tr>
<?php } ?>
</table>		
...
$('.modal').on('shown.bs.modal', function() {
 ...
 $(function() {
	$(document).on('click',"button#hapus_data",function(){
			...
			url: "<?php echo base_url().FOLDER_SMP_USER;?>kuisioner/aksihapuskuisioner",
				beforeSend: function(){
				},
