...
var prov = opt.val();
if (!prov) return;
xmlhttp_.open('get', '<?php echo base_url().FOLDER_SMP_USER; ?>sekolah/ambildatakotakab?nama_provinsi='+prov, true);
...
xmlhttp2_.open('get', '<?php echo base_url().FOLDER_SMP_USER; ?>sekolah/ambildatakecamatan?nama_kotakab='+kotakab+'&nama_provinsi='+prov, true);
...
xmlhttp3_.open('get', '<?php echo base_url().FOLDER_SMP_USER; ?>sekolah/ambildatakelurahan?nama_kec='+kec+'&nama_kotakab='+kotakab+'&nama_provinsi='+prov, true);
...
xmlhttp4_.open('get', '<?php echo base_url().FOLDER_SMP_USER; ?>sekolah/ambildatanodaerah?nama_desa_kel='+kel+'&nama_kec='+kec+'&nama_kotakab='+kotakab+'&nama_provinsi='+prov, true);
	...
	$(document).on('click', "button#submit_edit", function(){
		...
		if ($('form.form_edit_data').valid()) {
			...
			cache: false,
     		contentType: false,
     		processData: false,
			url: "<?php echo base_url().FOLDER_SMP_USER;?>sekolah/aksieditsekolah",
			data: databaru,
				beforeSend: function(){
				},
