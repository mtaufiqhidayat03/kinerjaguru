	...
	$(document).on('click', "button#submit_guru", function(){
		...
		if ($('form.form_guru_sekolah').valid()) {
			...
			cache: false,
      		contentType: false,
      		processData: false,
			url: "<?php echo base_url().FOLDER_SMP;?>guru/aksieditgurusekolah",
			data: databaru,
				beforeSend: function(){
				},
