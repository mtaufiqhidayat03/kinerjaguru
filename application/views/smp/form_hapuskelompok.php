...
<tr>
<td width="2%"></td>
    <td width="92%"><h4>Apakah anda ingin menghapus <b><?php echo $row->kelompok_kompetensi; ?></b> ?</h4></td>
    <td></td>
    </tr>
    <tr>
    <td colspan="3" style="display:none">
    <input name="id_kelompok" type="text"  readonly value="<?php echo $row->id_kelompok; ?>" />
    </td>
</tr>
<?php } ?>
</table>		
...
$(function() {
	$(document).on('click',"button#hapus_data",function(){
			...
			url: "<?php echo base_url().FOLDER_SMP;?>kelompok/aksihapuskelompok",
				beforeSend: function(){
				},
