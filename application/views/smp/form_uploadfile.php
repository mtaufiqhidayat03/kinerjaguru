...
<tr valign="top">
   ...
   <td height="50"></td>
    ...
    <input name="editkelompok_kompetensi2" id="editkelompok_kompetensi2" type="text" readonly value="<?php echo $baris->id_kelompok_kuisioner_smp;?>" />
	</td>
	<td></td>
</tr>
<tr>
	...
	$(document).on('click', "button#submit_file", function(){
		...
		if ($('form.form_upload_file').valid() && document.querySelector("#pdf-file").value !== "") {
			...
			cache: false,
      		contentType: false,
      		processData: false,
			url: "<?php echo base_url().FOLDER_SMP;?>kuisioner/aksiuploadfilekuisioner",
			data: databaru,
				beforeSend: function(){
				},
