...
<tr>
<td width="2%"></td>
    <td width="92%"><h4>Apakah anda ingin menghapus penilaian kinerja <b><?php foreach ($n1 as $row1) {
    echo $row1->nama_guru;} ?></b> untuk indikator <b><?php echo $row->nama_indikator; ?></b> ?</h4></td>
    <td></td>
    </tr>
    <tr>
    <td colspan="3" style="display:none">
	<input name="id_indikator" type="text" required readonly value="<?php echo $row->id_indikator; ?>" />
	<input name="id_penilaian" type="text" required readonly value="<?php echo $row->id_penilaian; ?>" />
	<input name="nuptk_penilaian_smp" type="text" required readonly value="<?php echo $row->nuptk_penilaian_smp; ?>" />
    </td>
</tr>
<?php } ?>
</table>		
...
$('.modal').on('shown.bs.modal', function() {
 ...
 $(function() {
	$(document).on('click',"button#hapus_data",function(){
			...
			url: "<?php echo base_url().FOLDER_SMP;?>penilaian/aksihapuspenilaian",
				beforeSend: function(){
				},
