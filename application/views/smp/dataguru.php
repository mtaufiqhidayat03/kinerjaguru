					...
					<div class="kt-portlet kt-portlet--tab">
						...
						<div class="kt-portlet__body">
							...
							<a class="btn btn-success btn-elevate btn-icon-sm btn-elevate2 btn-elevate-air2"
										href="<?php echo base_url().FOLDER_SMP."guru/form_addguru";?>"
							...
							<a class="btn btn-brand btn-elevate btn-icon-sm btn-elevate2 btn-elevate-air2"
										href="<?php echo base_url().FOLDER_SMP."guru";?>"
										 id="guru_semua">
										<i class="flaticon-users-1"></i>
										Tampilkan Semua Guru SMP
									</a>
							<?php } ?>
							<a class="btn btn-dark btn-elevate btn-icon-sm btn-elevate2 btn-elevate-air2"
										href="<?php echo base_url().FOLDER_SMP."sekolah";?>"
										 id="sekolah_semua">
							...
							<?php if (!isset($npsn_nss)) { ?>
									<a class="btn btn-success btn-elevate btn-icon-sm btn-elevate2 btn-elevate-air2"
										href="<?php echo base_url().FOLDER_SMP."guru/exportguru";?>"
							...
							<?php } else { ?>
								<a class="btn btn-success btn-elevate btn-icon-sm btn-elevate2 btn-elevate-air2"
										href="<?php echo base_url().FOLDER_SMP."guru/exportguru?npsn_nss=".$npsn_nss;?>"
										data-target="#" id="sample_export_excel">
										<i class="fa fa-file-excel"></i>
