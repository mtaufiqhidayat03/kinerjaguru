		...
		<div class="row">
				<div class="col-sm-12">
					...
					<div class="kt-portlet kt-portlet--tab">
						...
						<i class="flaticon-interface-6" style="padding-right:5px"></i> Kelompok Kompetensi
						</h3>
						</div>
						...
						<div class="kt-portlet__body">
							...
							<a class="btn btn-success btn-elevate btn-icon-sm btn-elevate btn-elevate-air"
										href="<?php echo base_url().FOLDER_SMP."kelompok/form_addkelompok";?>"
							...
							<div class="alert alert-warning data_kelompok" style="display:none"></div>
							<table class="table table-striped table-bordered table-hover data_kelompok dataTables" id="data_kelompok" width=100%>
								<thead>
									<tr>
										<th></th>
										<th>Tindakan</th>
					...
					<style type="text/css">
						...
						#hub_data .portlet-body {
							min-width: 750px;
						}

						#hub_data .modal-footer {
							border-bottom: 1px solid #e5e5e5;
						}
					</style>
					...
					<div class="modal fade" id="hub_data" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
