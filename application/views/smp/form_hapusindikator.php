...
<tr>
<td width="2%"></td>
    <td width="92%"><h4>Apakah anda ingin menghapus <b><?php echo $row->nama_indikator; ?></b> ?</h4></td>
    <td></td>
    </tr>
    <tr>
    <td colspan="3" style="display:none">
    <input name="id_indikator" type="text" readonly value="<?php echo $row->id_indikator; ?>" />
    </td>
</tr>
<?php } ?>
</table>		
...
$('.modal').on('shown.bs.modal', function() {
 ...
 $(function() {
	$(document).on('click',"button#hapus_data",function(){
			...
			url: "<?php echo base_url().FOLDER_SMP;?>indikator/aksihapusindikator",
				beforeSend: function(){
				},
