...
<button type="button" class="btn btn-success btn-elevate2 btn-elevate-air2" id="ganti_nilai"><i class="fa fa-pencil-alt"></i> Edit Nilai Kuisioner</button>
	...
	$(document).on('click', "button#ganti_nilai", function(){
		...
		if ($('form.form_upload_file2').valid()) {
			...
			cache: false,
      		contentType: false,
      		processData: false,
			url: "<?php echo base_url().FOLDER_SMP;?>hasilkuisioner/aksigantinilaikuisioner",
			data: databaru,
				beforeSend: function(){
				},
